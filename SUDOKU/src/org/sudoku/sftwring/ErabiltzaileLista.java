...
public void gehituErabiltzaile(String pIzena,String pAbizena,String pPasahitza){
	if(!badago(pIzena))
		erabiltzaileLista.add(new Erabiltzaile(pIzena,pAbizena,this.erabiltzaileLista.size()+1,new Sudokua(),pPasahitza));
...
public Erabiltzaile bilatuErabiltzaile(String pIzen,String pPasaHitza){
	...
	while(itr.hasNext()){
		...
		if (unekoErabiltzaile.getIzen()==pIzen&&unekoErabiltzaile.getPasahitza()==pPasaHitza){
...
private boolean badago(String pIzen){
